        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-4 lg:grid-cols-4">
          {certs.map((c, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.01] p-5 backdrop-blur-md transition-all duration-500 hover:border-white/20"
            >
              {/* Accent glow */}
              <div
